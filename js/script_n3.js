// Global variable for storing fetched data (optional, adjust as needed)
let data;
...
function updateDataAndDOM(url) {
  fetch(url)
    ...
    .then(fetchedData => {
      ...
      setTimeout(updateDataAndDOM, 5000); // Update data again after 5 seconds
    })
    .catch(error => {
